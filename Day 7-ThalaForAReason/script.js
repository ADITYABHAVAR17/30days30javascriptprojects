function stopAudio() { var sound = document.getElementsByTagName('audio')[0];
    sound.pause();}
...
function checkThala() {
    ...
    if (sum == 7) {
        ...
        Swal.fire({
            ...
            html: '<video width="400px" autoplay muted loop class="text-center"><source src="./assets/correct.mp4" type="video/mp4"></video> <p>Thala For A Reason!</p>',
            // html: '',
        ...
        // DelayNode(5000).then(() => {sound.pause();});
    } else {
        Swal.fire({
            title: "Wrong!",
